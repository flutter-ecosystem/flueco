...
Packages with other changes:
 ...
 - [`flueco` - `v0.0.1-alpha.5`](#flueco---v001-alpha5)
 - [`flueco_auto_route` - `v0.0.1-alpha.5`](#flueco_auto_route---v001-alpha5)
 - [`flueco_core` - `v0.0.1-alpha.5`](#flueco_core---v001-alpha5)
...
#### `flueco` - `v0.0.1-alpha.5`

 - **REFACTOR**(widgets): rename FluecoCoreApp.
 - **FEAT**(flueco): registers base registries.

#### `flueco_auto_route` - `v0.0.1-alpha.5`

 - **REFACTOR**: change deprecated usage fro auto_route.

#### `flueco_core` - `v0.0.1-alpha.5`
